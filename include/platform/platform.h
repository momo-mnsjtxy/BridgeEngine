...
typedef struct {
	...
	void (*set_render_draw_color)(plat_renderer_t renderer, uint8_t r, uint8_t g, uint8_t b, uint8_t a);
	...
	void (*render_texture)(plat_renderer_t renderer, plat_texture_t texture,
			       float x, float y, float w, float h);

	
	plat_texture_t (*create_texture_from_surface)(plat_renderer_t renderer, plat_surface_t* surface);
	plat_texture_t (*create_texture)(plat_renderer_t renderer,
	...
	plat_surface_t* (*render_text_blended)(plat_font_t font,
	...
	plat_audio_stream_t (*open_audio_device_stream)(plat_audio_format_t format, int channels, int freq);
	...
	int (*load_wav)(const char* filepath, plat_audio_spec_t* spec, uint8_t** buffer, uint32_t* length);
